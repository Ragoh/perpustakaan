...
@section('title', 'Login - PerpusKu')

@section('content')
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-secondary-200">
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-secondary-900">Selamat Datang!</h2>
            <p class="text-secondary-600 mt-1">Masuk ke akun Anda</p>
        </div>
        ...
        <form action="{{ route('login.post') }}" method="POST" class="space-y-5">
            ...
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 text-sm text-secondary-600">Ingat saya</label>
            </div>
